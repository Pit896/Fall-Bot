...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!searchString)return sendError("Please insert a title to play", message.channel);
        ...
        if (serverQueue) {
          ...
          .setAuthor("Added to Queue👍", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
