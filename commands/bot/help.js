...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if(!args[0]) {
            ...
            .setDescription("`8ball` **|** `ascii` **|** `cookie` **|** `dice` **|** `djs` **|** `meme` **|** `rip` **|** `wasted` **|** `translate` **|** `triggered`")
            .setColor('YELLOW')
            .setFooter("Requested by " + message.author.username, message.author.displayAvatarURL({ dynamic: true }))
            .setTimestamp()
            .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))    
            ...
            .setDescription("`loop` **|** `lyrics` **|** `np` **|** `pause` **|** `play` **|** `queue` **|** `remove` **|** `resume` **|** `search` **|** `shuffle` **|** `skip` **|** `skipto` **|** `stop` **|** `volume`")
            .setColor('#59324c')
            .setFooter("Requested by " + message.author.username, message.author.displayAvatarURL({ dynamic: true }))
            .setTimestamp()
            .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))    
